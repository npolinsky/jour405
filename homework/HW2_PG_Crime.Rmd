...
There are multiple different categories including certain ones that have additional categories. For example, there's assault, assault shooting, and assault with a weapon. They're all seperate categories but they all fall within a similar action. There's a similar theme with robbery, which is very similar to theft but involves some sort of intimidation tactic. There's robbery commercial, which would be from stores or merchants, robbery residential which would be from a home, robbery vehicle which would be from a vehicle, and then robbery other which blankets other things. 

The main ones I would be looking at would be robbery, theft, and assault, because they're the most common and the sample size allows you to find legitimate trends.

I'd say all the different categories of robberies are helpful, but also create a bit of a mess and confusion. For example, from January to February, commercial and vehicle robberies increased, but all other robberies decreased.
...
Accidents are the most recorded crime on a per month basis. Auto crimes are also very common. The second highest recorded stat per month is stolen auto, and the third is theft from auto. This shows me cars are heavily targeted in Prince George's County.

I am curious as to why car accidents became more common as the year went on. Also, general theft skyrocketed in October compared to every other month.
...
The results are definitely a mixed bag. A category that you'd assume would follow this theory would be theft. It ended up being the contrary. Though the changes were small, all three summer months averages fell below the full year average. 
...
Tons of people drive a vehicle, but what many don't realize is that once they park it, it becomes a massive target for crime in Prince George's County.

Outside of car accidents, the next two highest recorded incidents in PG County were stolen automobiles, and theft from automobiles. In 2024, nearly 400 cars were stolen per month on average, with October recording the highest single-month tally at 462. Theft from automobiles wasn't far behind, with nearly 392 being recorded during the same time period.
