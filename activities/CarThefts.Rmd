...
The distribution is skewed to the left. This means that the mean is less than the median. 

The largest cluster of the data set falls within a standard deviation of the mean. That group seems to consist of 11-17 thefts, which each of those occurences happened at least five times. I'd estimate that around 21-22 of the days fall within a standard deviation, somewhere around 65-70%.
